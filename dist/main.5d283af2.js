...
dom.style(div5, 'color', 'red'); // 设置 div.style.color

var divList5 = dom.find('.red'); // 获取多个 div.red 元素
dom.each(divList5, function (n) {
    return console.log(n);
}); // 遍历 divList 里的所有元素
},{}]},{},["epB2"], null)
//# sourceMappingURL=main.5d283af2.map